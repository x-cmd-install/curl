...
合计: **271,721** 行代码（覆盖前 5 种语言、共 **1176** 个文件）。
...
- **Star**: 42,827 · **Fork**: 7,350 · **开放 issue**: 5,571 · **贡献者**: 1,250

## 累计统计

- **发布数**: 98 · **已合并 PR**: 212 · **开放 PR**: 42 · **已关闭 issue**: 5566 · **开放 issue**: 5 · **提交数**: 39706
...
在 [repology.org](https://repology.org/project/curl) 上共有 **886** 个发行版报告此项目。**152** 个 ✅ 已是最新上游版本，**403** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:18:25Z._
