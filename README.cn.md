...
- **Star**: 42,829 · **Fork**: 7,350 · **开放 issue**: 5,571 · **贡献者**: 1,250

## 累计统计

- **发布数**: 98 · **已合并 PR**: 212 · **开放 PR**: 44 · **已关闭 issue**: 5566 · **开放 issue**: 5 · **提交数**: 39706
...
在 [repology.org](https://repology.org/project/curl) 上共有 **887** 个发行版报告此项目。**153** 个 ✅ 已是最新上游版本，**403** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:10:13Z._
